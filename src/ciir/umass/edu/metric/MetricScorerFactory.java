...
public class MetricScorerFactory {
    ...
    private static MetricScorer[] mFactory = new MetricScorer[]{new NDCGScorer(), new DCGScorer(), new PrecisionScorer(), new ReciprocalRankScorer(), new BestAtKScorer(), new ERRScorer()};
